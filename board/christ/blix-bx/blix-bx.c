...
{
	imx_iomux_v3_setup_multiple_pads(disp0_bkl_pads, ARRAY_SIZE(disp0_bkl_pads));
...
static iomux_v3_cfg_t const usb_hc1_pads[] = {
	MX6_PAD_EIM_DA12__GPIO3_IO12 | MUX_PAD_CTRL(NO_PAD_CTRL), /* rst_usb_hub */
};
